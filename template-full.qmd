...
header: Please click [HERE](https://kazuyanagimoto.com/quarto-academic-typst/) for the full documentation.
author:
...
abstract: |
  {{< lipsum 1 >}}
thanks: |
  This template is inspired by Kieran Healy's [LaTeX and Rmd template](https://github.com/kjhealy/latex-custom-kjh) and Andrew Heiss's [Hikmah Quarto template](https://github.com/andrewheiss/hikmah-academic-quarto).
...
You can cite a reference like this [@sun2021] or @callaway2021.
